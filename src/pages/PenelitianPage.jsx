  ...
  return (
    <>
      ...
      <Container className=" mt-5 mb-5" id="informasi">
        ...
        <h2 className="text-2xl font-bold text-gray-800 mt-5 mb-4">Profil Penelitian</h2>
        ...
        <div className="grids grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
          <div>
            <h4 className="fw-normal">
              <strong>Judul Penelitian:</strong> Tim Riset Genesis
            </h4>
          </div>
          <div>
            <h4 className="fw-normal">
              <strong>Penerima Penelitian:</strong> Penelitian Artificial Intelligence for Sustainable Agriculture
            </h4>
          </div>
          <div>
            <h4 className="fw-normal">
